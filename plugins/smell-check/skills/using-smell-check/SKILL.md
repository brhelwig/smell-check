...
- Delete every comment that traces to an agent, across the whole file you are editing. Run `git blame`; a commit authored or co-authored by an agent counts as agent output. A person's comments
